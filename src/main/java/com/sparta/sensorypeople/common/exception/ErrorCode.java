...
public enum ErrorCode {
    ...
    // 공통 오류 코드
    FAIL(500, "실패했습니다."),
    NOT_ENUM_VALUE(400, "잘못된 입력값입니다."),

    // 사용자 도메인 오류 코드
    FAIL_FIND_USER(400, "해당 유저를 찾을 수 없습니다."),
    DUPLICATE_USER(400, "중복된 사용자가 존재합니다."),
    DUPLICATE_EMAIL(400, "중복된 이메일이 존재합니다."),
    INCORRECT_ADMIN(400, "관리자 암호가 일치하지 않습니다."),
    USER_NOT_FOUND(404, "해당 아이디의 유저를 찾지 못했습니다."),
    INCORRECT_PASSWORD(401, "입력하신 비밀번호가 일치하지 않습니다."),
    ...
    INVALID_USER_INFO(401, "유효하지 않은 사용자 정보입니다."),
    UNAUTHORIZED_USER(401, "사용자 정보가 없습니다."),
